...
<body>
	...
	<div class="navbar navbar-fixed-top">
			<div class="container">
				...
				</a> <a class="brand" href="DepartmentWelcome.jsp">Departments Module</a>
			</div>
		</div>
		<br>
	<div class="wrapper">
									...
									<div class="module-body table">
										<table cellpadding="0" cellspacing="0" border="0"
											 ...
											 <tbody>
												...
												<% try 
												{ 
                          //int val = Integer.parseInt(request.getParameter("DataTables_Table_0 length"));
                         // int i=-1;
					                String dname = (String) session.getAttribute("dname");
													Connection con=Connect.getCon();													
                                                    Statement st=con.createStatement();
                                                    ResultSet rs=st.executeQuery("select  gid,hno,to_char(day,'dd-mon-yy'),problem,status,category,doc from grievance where dname='"
					                                   + dname + "'");
			                                  while (rs.next()) {
                                           /*i=i+1;
                                          if(i==val)
